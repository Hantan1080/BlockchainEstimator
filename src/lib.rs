// src/lib.rs
/*
 * Core library for BlockchainEstimator
 */
...
#[derive(Debug)]
pub struct BlockchainEstimatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockchainEstimatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockchainEstimator processing");
    
    let mut processor = BlockchainEstimatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockchainEstimatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockchainEstimatorProcessor::new(false);
